...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-2xl border border-neutral-800 bg-zadel-elevated p-6 sm:p-8">
        ...
        <div className="rounded-xl border border-neutral-800 bg-zadel-elevated p-6 space-y-4">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div>
              ...
              <span className="text-neutral-300 font-mono">admins, system/admin_config</span>
            </div>
            <div>
      ...
      <div className="rounded-xl border border-neutral-800 bg-zadel-elevated p-6 space-y-4">
        ...
        <div className="p-4 rounded-lg bg-neutral-900/60 border border-neutral-800/60 text-xs text-neutral-400 space-y-2">
          <p>
            • All admin routes (<code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin</code>, <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin/products</code>, <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin/categories</code>, <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin/reviews</code>, <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin/contact</code>, <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin/settings</code>) are guarded by <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">ProtectedRoute</code>.
          </p>
          <p>
            • Unauthenticated visitors attempting to access any admin URL are immediately redirected to <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-zadel-gold font-mono">/admin/login</code>.
          </p>
          <p>
