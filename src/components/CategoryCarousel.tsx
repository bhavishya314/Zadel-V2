  ...
  return (
    <div className="relative">
      <button
        ...
        className={`icon-btn absolute top-1/2 z-20 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-foreground/20 bg-zadel-black/90 text-foreground shadow-md backdrop-blur-md lg:flex ${
          canPrev
        ...
        {categoriesList.map((cat, i) => (
          ...
          >
            <Link
              ...
              className="group relative block aspect-[4/5] overflow-hidden rounded-xl bg-neutral-950 shadow-none transition-shadow duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:shadow-[0_16px_40px_rgba(0,0,0,0.18)]"
              draggable={false}
            ...
            >
              ...
              />
              <div className="category-card-overlay absolute inset-0 bg-gradient-to-t from-black/95 via-black/50 via-45% to-transparent" />
              <div className="absolute inset-x-0 bottom-0 p-5">
                <p className="category-card-title font-display text-xl font-medium tracking-wide text-white group-hover:text-white">
                  {cat.name}
                </p>
                {cat.description && (
                  <p className="category-card-desc mt-1 text-xs text-white/80 transition-colors duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:text-zadel-gold">
                    {cat.description}
                  </p>
                )}
              </div>
